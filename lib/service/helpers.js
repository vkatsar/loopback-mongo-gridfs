...
module.exports = {
    ...
    fileUpload(ctx, container, fileStream, filename, mimetype) {
        const gfs = new GridFSBucket(ctx.db);
    ...
    async fileUploadFromRequest(ctx, container, req) {
        ...
        const promises = files.map(({buffer, originalname, mimetype}) => {
            ...
            return this.fileUpload(ctx, container, fileStream, originalname, mimetype);
        });
